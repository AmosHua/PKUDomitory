...
public class InfoActivity extends AppCompatActivity implements View.OnClickListener, NetWorkCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.location)).setText(Util.student.getData().getLocation());
